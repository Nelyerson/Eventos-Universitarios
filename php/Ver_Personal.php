...
?>
    ...
    <h2 class="pageheader-title" style="display: inline-block; vertical-align: middle;">Lista de personal <i class="fa fa-address-card"></i></h2>
</div>
    ...
    <?php if (isset($_GET['status']) && $_GET['status'] == 'cedula'): ?>
        <div class="alert alert-danger" role="alert">
            La cedula introducida esta ya registrada.
        </div>
    <?php endif; ?>
                    ...
                    <div class="card-header">
                                ...
                                <p>Aqui abajo puede ver todo el personal que haya registrado.</p>
                            </div>                 
...
<a href="Ver_Personal_PDF.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
<?php
...
?>
<tr>
<td><img height="150px" width="150px" src="<?php echo $row2['foto']; ?>"/></td>
...
<?php
include 'editarPersonall.php';

include 'eliminarpersona.php';
