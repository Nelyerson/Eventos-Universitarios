...
<div class="modal fade" id="eliminarr<?php echo $row ['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">¿Estas seguro de eliminar al usuario <?php echo $row['username'];?>?"</h5>
      ...
      <form action="SuperEliminUsurio.php" method="POST">
