...
$query = "SELECT * FROM usuarios WHERE privilegio= 0";
...
$ids = $row3['id'];
    ...
    $sql2 = "INSERT INTO pagos (id, referencia,foto,code,nombre,status1,ide, fecha) VALUES (NULL,'$referencia','$archivo','$code','$escuela','Pendiente','$id','$fecha')";
    $resultado = mysqli_query($conexion,$sql2);
    
       $query = "UPDATE usuarios SET referencia = '$referencia' WHERE username = '$escuela'";
$resultado = $conexion->query($query);


    $sql3 = "INSERT INTO noti (id, texto,fecha,accion,ide) VALUES (NULL,'Ha sido notificado de un pago del usuario','$fecha','$user','$ids')";
    $resultado = mysqli_query($conexion,$sql3);

    if ($resultado) {
        header("Location: VerpagosG.php");
    } else {
