...
?>
    ...
    <h2 class="pageheader-title" style="display: inline-block; vertical-align: middle;">Pagos Pendiente <i class="fa fa-address-card"></i></h2>
</div>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="homesss.php" class="breadcrumb-link">Inicio</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Pagos Pendiente</li>
                                    </ol>
                                </nav>
                            </div>
                            <br>
  ...
  <table id="example" class="table table-striped table-bordered second" style="width:100%">
		...
		<thead>
			<tr>
				            <th colspan="6" class="text-center">Pagos Pendientes</th>
...
<a href="Pago_Pendientes.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
...
require 'conexion.php';
    ...
    $query = "SELECT * FROM pagos WHERE ide= '$ide' AND status1 = 'Pendiente'ORDER BY fechar DESC";
...
<th><a  href="apro.php?id=<?php echo $row8['id'];?>&user=<?php echo $username;?>&id2=<?php echo $row['id'];?>&id3=<?php echo $row8['idee'];?>"onclick="return confirm('¿Desea confirmar este pago?')"> Aprobar</a> <br> <br>
<a  href="dele.php?id=<?php echo $row8['id'];?>&user=<?php echo $username;?>&id2=<?php echo $row['id'];?>&id3=<?php echo $row8['idee'];?>"onclick="return confirm('¿Desea eliminar este pago?')"> Eliminar</a></th>
