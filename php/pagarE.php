                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="ppagoE.php" method="POST" enctype="multipart/form-data">
                                

      <?php   $query = "SELECT * FROM usuarios WHERE id= '$idee'";
$resultado=$conexion->query($query);
$row3 = $resultado->fetch_assoc();

?>

<label for="inputText3" class="col-form-label">Datos del pago movil: <?php echo $row3['banco'];?> </label>    <br>
<label for="inputText3" class="col-form-label">Monto a pagar: <?php echo $row3['membresia'];?> </label>    <br>
<label for="inputText3" class="col-form-label">Numero de Referencia: </label>        
                                    ...
                                    <input  name="Datos de Pago" type="text"  maxlength= "40" minlength="5"  pattern= "[0-9]+">
                                    </div>
                                          Monto Transferido   <div class="contenedor">
                                    <input  name="Monto a Pagar" type="text"  maxlength= "40" minlength="5"  pattern= "[0-9]+">
                                    </div>
...
<br>
			...
			<input style=" display: none;" type="text" class="form-control" name="ide"  placeholder="Nombres" value="<?php echo $row['ide'];?>"/><br><br>
