            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Agregar Evento</h2>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Crear Nuevo Evento</h5>
                            <div class="card-body">
                                <form action="agregareventop.php?user=super" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Espacio</label>
                                        <input id="inputText3" name="campo" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+">
                                    </div>

                                    <div class="form-group">
                                                <label for="input-select">Tipo de evento</label>
                                                <select class="form-control" id="input-select" name="tipo" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" name="fechai"type="date" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Fecha de Conclusión</label>
                                        <input id="inputText3" name="fechac" type="date" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Numeros de cupos</label>
                                        <input id="inputText3" name="cupos" type="number" class="form-control" maxlength= "4"   pattern= "[a-z A-Z]+">
                                 ...
                                 <?php
                                 $sql = "SELECT id, nombre, apellido, pnf FROM profesores";
