...
?>
                                ...
                                <form action="agregarestudiantep.php?id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" name="apellidos" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Cedula</label>
                                        <input id="inputText3" name="dni"type="text" class="form-control"required>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Numero de telefono</label>
                                        <input id="inputText3" name="telefono" type="text" class="form-control"required>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Discapacidad</label>
                                        <input id="inputText3" name="discapacidad" type="text" class="form-control" maxlength= "40" minlength="5" required="" pattern= "[a-z A-Z]+">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Direccion</label>
                                        <input id="inputText3" name="direccion" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+"required>
                                    </div>
