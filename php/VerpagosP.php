...
?>
    ...
    <h2 class="pageheader-title" style="display: inline-block; vertical-align: middle;">Pagos Confirmados <i class="fa fa-address-card"></i></h2>
</div>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="homesss.php" class="breadcrumb-link">Inicio</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Pagos Confirmados</li>
                                    </ol>
                                </nav>
                            </div>
                            <br>
...
<a href="Pago_Confirmados.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
...
if ($privilegio == 0) {
    ...
    $query = "SELECT * FROM pagos WHERE ide= '$ide'AND status1 = 'Aprobado' ORDER BY fechar DESC";
...
?>
<tr>
<td><img height="150px"  width="200"src="<?php echo $row8['foto']; ?>"/></td>
