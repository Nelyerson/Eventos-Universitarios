            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Agregar Estudiante</h2>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Eliga que institucion para la añadir el Estudiante</h5>
                            <div class="card-body">
...
<th><a href="agregarestudiante.php?id=<?php echo $row['id'];?>" >elegir</th>
