  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                                ...
                                <form action="editarestudiantep.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Nombres</label>
                                        <input id="inputText3" value="<?php echo $row2 ['nombres'];?>" name="nombre" type="text" class="form-control" maxlength= "40" minlength="5"  pattern= "[a-z A-Z]+">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Apellidos</label>
                                        <input id="inputText3"value="<?php echo $row2 ['apellidos'];?>" name="apellidos" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+" >
                                    </div>
                                    <div class="form-group">
    ...
    <select id="inputText7" name="sexo" class="form-control" required>
  
 
        <option <?php if ($row2['sexo'] == 'Masculino') echo 'selected'; ?>> Masculino</option>
        <option <?php if ($row2['sexo'] == 'Femenino') echo 'selected'; ?>>Femenino</option>
        <option <?php if ($row2['sexo'] == 'No binario') echo 'selected'; ?>>No binario</option>
        <option  <?php if ($row2['sexo'] == 'Otros') echo 'selected'; ?>>Otros</option>
    </select>
</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" value="<?php echo $row2 ['discapacidad'];?>"name="discapacidad" type="text" class="form-control" maxlength= "40" minlength="5" pattern= "[a-z A-Z]+">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Direccion</label>
                                        <input id="inputText3" value="<?php echo $row2 ['direccion'];?>"name="direccion" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+">
                                    </div>
                                    ...
                                    <input id="inputText3"  style=" display:none" value="<?php echo $row2 ['id'];?>" name="id" type="text" class="form-control" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="input-select" name="pnf" required>
                                                    ...
                                                    <option value="Informatica" <?php if ($row2['pnf'] == 'Informatica') echo 'selected'; ?>>Informatica</option>
                                                    <option value="Electronica" <?php if ($row2['pnf'] == 'Electronica') echo 'selected'; ?>>Electronica</option>
