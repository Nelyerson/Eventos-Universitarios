...
?>
        ...
        <div class="dashboard-wrapper">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-7 col-sm-12 col-12">
                            ...
                            <div class="influence-profile-content pills-regular">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link"   href="ListaDetalleagregado.php?id=<?php echo $row['id'];?>">Estudiantes Agregados</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-campaign" role="tabpanel" aria-labelledby="pills-campaign-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $dispo; ?></h1>
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $row ['cupos']; ?></h1>
                                                        <p>Cupos Totales</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h1 class="mb-1"><?php echo $row ['cantidad']; ?></h1>
                                                        <p>Estudiantes</p>
                                                    </div>
                                                </div>
                                            </div>
            ...
            $query = "SELECT * FROM estudiantes WHERE disp = 0 AND pnf = '$pnf' AND graduando = 0 ORDER BY id DESC";
            ...
            <th><a href="agregaralista.php?id=<?php echo $row['id'];?>">Agregar<i class="zmdi zmdi-edit"></i></a></th>
