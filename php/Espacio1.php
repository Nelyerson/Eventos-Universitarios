            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div style="text-align: center;">
                            <h2 class="pageheader-title">Agregar Espacio</h2>            <i class="fa fa-building fa-fw fa-3x text-primary"></i>
</div>
...
<label for="inputText3" class="col-form-label">Nombre y Capacidad: </label>        <br>
                                    <div class="contenedor">
                                    <input  name="lugar" type="text" placeholder=" Nombre del espacio" maxlength= "40" minlength="5" required="" pattern= "[a-z A-Z]+">
                                    </div>
                                    <div class="contenedordos">
                                    <input  name="Capacidad" type="number" placeholder="Capacidad de personas" maxlength= "40" minlength="5" required="">
                                    </div>
                                    <br>
                                    <br>     
                                    ...
                                    <label for="archivo" class="col-form-label">Agregar foto del lugar</label>
                                    <div style="text-align: center;">
