            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Editar Evento</h2>
...
?>
                                <form action="Supereditareventoo.php?id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" placeholder="<?php echo $row ['espacio'];?>" name="campo" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" placeholder="<?php echo $row ['Cupos'];?>" name="cupos" type="number" class="form-control" maxlength= "4"   pattern= "[a-z A-Z]+">
                                    </div>
