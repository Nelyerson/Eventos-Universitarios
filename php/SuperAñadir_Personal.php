            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Añadir Personal</h2>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="Supergregarpersonal.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputText3" name="apellido" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Especialidad</label>
                                        <input id="inputText3" name="Especialidad" type="text" class="form-control" maxlength= "70" minlength="5"  pattern= "[a-z A-Z]+">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Telefono</label>
                                        <input id="inputText3" name="Telefono"type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">DNI</label>
                                        <input id="inputText3" name="DNI"type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Direccion</label>
                                        <input id="inputText3" name="Direccion"type="text" class="form-control">
                                    </div>
