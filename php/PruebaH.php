...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, ("REPORTE DE EVENTOS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(45, 10, ('PNF'), 1, 0, 'C', 1);
      $this->Cell(25, 10, ('FI'), 1, 0, 'C', 1);
      $this->Cell(25, 10, ('FC'), 1, 0, 'C', 1);
      $this->Cell(25, 10, ('HI'), 1, 0, 'C', 1);
      $this->Cell(25, 10, ('HC'), 1, 0, 'C', 1);
      $this->Cell(60, 10, ('Espacio'), 1, 1, 'C', 1);
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(45, 10, ($row['pnf']), 1, 0, 'C', 0);
    $pdf->Cell(25, 10, (date("d-m-Y", strtotime($row['fechai']))), 1, 0, 'C', 0);
    $pdf->Cell(25, 10, (date("d-m-Y", strtotime($row['fechac']))), 1, 0, 'C', 0);
    $pdf->Cell(25, 10, ($row['horai']), 1, 0, 'C', 0);
    $pdf->Cell(25, 10, ($row['horac']), 1, 0, 'C', 0);
    $pdf->Cell(60, 10, ($row['espacio']), 1, 1, 'C', 0);
