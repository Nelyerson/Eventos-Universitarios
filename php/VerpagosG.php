...
?>
  ...
  <table id="example" class="table table-striped table-bordered second" style="width:100%">
		...
		<thead>
			<tr>
		            <th colspan="5" class="text-center">Historial de Pagos</th>
...
<a href="Historial_Pagos.php" target="_blank" class="btn btn-primary">Exportar a PDF</a>
...
$query = "SELECT * FROM pagos WHERE ide='$ide' ORDER BY fechar DESC";
