...
$ids = $row3['id'];
    ...
    $query = "SELECT * FROM pagos WHERE referencia= '$referencia'";
$resultado=$conexion->query($query);
$row = $resultado->fetch_assoc();

	if (mysqli_num_rows($resultado) > 0 ){
		header("Location:refeerrormessaje.php"); exit ();
    ...
    $sql2 = "INSERT INTO pagos (id, referencia,foto,code,nombre,status1,ide, fecha, idee) VALUES (NULL,'$referencia','$archivo','$code','$user','Pendiente','$ide','$fecha', '$id')";
    ...
    if ($resultado) {
        header("Location: VerpagosEE.php");
    } else {
