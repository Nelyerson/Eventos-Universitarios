...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, ("PAGOS CONFIRMADOS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(60, 10, ('Fecha de Pago'), 1, 0, 'C', 1);
      $this->Cell(60, 10, ('Fecha de Revision'), 1, 0, 'C', 1);
      $this->Cell(80, 10, ('Nombre'), 1, 1, 'C', 1);
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(60, 10, (date("d-m-Y", strtotime($row['fecha']))), 1, 0, 'C', 0);
    $pdf->Cell(60, 10, (date("d-m-Y", strtotime($row['fechar']))), 1, 0, 'C', 0);
